...
array6 = [0, 0, 0, 0, 0, 1, 8, 9, 11, 11, 1000, 1002, 1003]
array7 = [0, 0, 0, 2, 4, 5, 6, 8, 9, 20, 21, 24, 26]
array8 = [0, 0, 0, 2, 4, 5, 6, 8, 9, 20, 21, 24, 26, 28, 29, 30, 31, 32, 33]
array9 = [0, 0, 0, 0, 1, 3, 5, 7, 9, 12, 13, 16, 17, 18, 19, 21, 22, 24, 26, 27, 29, 30, 31, 32, 34, 36, 37]
...
class TestSequence(unittest.TestCase):
    def test_sequence(self):
        ...
        self.assertEqual(max_sequence(array2, joker(array2)), 3)
